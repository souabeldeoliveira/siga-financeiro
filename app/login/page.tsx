...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-md py-8 sm:py-16">
      <Card>
        <Image src="/cazabela-app-icon-v3.png" alt="Símbolo da Cazabela" width={48} height={48} preload className="size-12 rounded-2xl object-cover shadow-[0_8px_18px_rgba(91,52,38,0.22)]" />

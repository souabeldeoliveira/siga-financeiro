  ...
  return (
    <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[var(--background)]/95 backdrop-blur lg:hidden">
      <div className="flex items-center gap-3 px-4 py-3">
        <Link href="/dashboard" className="shrink-0" aria-label="Cazabela — Gestão Financeira — Dashboard"><Image src="/cazabela-app-icon-v3.png" alt="" width={40} height={40} className="size-10 rounded-2xl object-cover shadow-[0_6px_14px_rgba(91,52,38,0.2)]" /></Link>
